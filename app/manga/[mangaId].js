      ...
      {loading ? (
        ...
        <ul className="divide-y divide-zinc-200 dark:divide-zinc-800">
          {chapters.map((ch) => (
            <li
              key={ch.id}
              className="py-3 flex justify-between items-center px-4 bg-white dark:bg-zinc-900 rounded-xl my-2 shadow hover:shadow-lg transition-all duration-200 border border-zinc-100 dark:border-zinc-800"
            >
